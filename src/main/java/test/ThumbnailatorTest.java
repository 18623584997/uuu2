...
//        thumbnailatorTest.test9();
    ...
    private void test1() throws IOException {
        ...
        Thumbnails.of("c:/1.jpg").size(256, 256).toFile(
                "C:/image_2560x2048.png");

        Thumbnails.of("C:/image_2560x2048.png").sourceRegion(Positions.CENTER, 200,
                200).size(200, 200).keepAspectRatio(false).toFile(
